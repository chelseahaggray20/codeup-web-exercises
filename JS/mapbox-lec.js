...
//in order to customize certain values, it has to be passed into the code. Example below.
...
//     geocode(search:"The Alamo, San Antonio TX, 78205", mapboxToken).then(onfulfilled: function f(result) {
//     console.log(result)
...
reverseGeocode(coordinates:{lng: -98.4861, lat: -29.4252}, mapboxToken).then(onfulfilled: function(result){
    console.log(result);
}